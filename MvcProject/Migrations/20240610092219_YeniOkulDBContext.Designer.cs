...
{
    [DbContext(typeof(NewOkulDBContext))]
    [Migration("20240610092219_YeniOkulDBContext")]
    partial class YeniOkulDBContext
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("İntProgOdev.Models.Ders", b =>
                {
                    ...
                    b.ToTable("tblDerslerNew", (string)null);
                });
            ...
            modelBuilder.Entity("İntProgOdev.Models.Ogrenci", b =>
                {
                    ...
                    b.ToTable("tblOgrencilerNew", (string)null);
                });
            ...
            modelBuilder.Entity("İntProgOdev.Models.RelationShips.OgrenciDers", b =>
                {
                    ...
                    b.ToTable("tblOgrenciDerslerNew", (string)null);
                });
